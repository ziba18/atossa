...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    rowText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', color: c.textPrimary },
    rowSub: { fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.textMuted },
    rowMeta: { fontSize: FontSize.xs, fontFamily: 'Fraunces_500Medium', color: c.textSecondary },
    sevPill: {
    ...
    sevText: { fontSize: 11, fontFamily: 'Fraunces_600SemiBold' },
  });
}
