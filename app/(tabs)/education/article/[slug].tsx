...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    notFoundText: { fontFamily: 'CormorantGaramond_400Regular', color: c.textMuted },
    ...
    categoryText: { fontSize: 10, fontFamily: 'CormorantGaramond_600SemiBold', color: c.cherry, letterSpacing: 1.2 },
    title: { fontSize: 26, fontFamily: 'CormorantGaramond_500Medium_Italic', color: c.textPrimary, lineHeight: 32, marginBottom: Spacing.sm },
    metaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: Spacing.md },
    metaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    metaText: { fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_400Regular', color: c.textMuted },
    ...
    sourceLabel: { fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_400Regular', color: c.textMuted },
    sourceName: { fontSize: FontSize.sm, fontFamily: 'CormorantGaramond_600SemiBold', color: c.textPrimary, marginTop: 1 },
  });
}

function createMarkdownStyles(c: AppColors) {
  return {
    body: { fontSize: FontSize.md, fontFamily: 'CormorantGaramond_400Regular', color: c.textPrimary, lineHeight: 26 },
    heading1: { fontSize: 26, fontFamily: 'CormorantGaramond_500Medium_Italic', color: c.textPrimary, marginBottom: Spacing.md, marginTop: Spacing.sm },
    heading2: { fontSize: 20, fontFamily: 'CormorantGaramond_600SemiBold', color: c.textPrimary, marginBottom: Spacing.sm, marginTop: Spacing.lg },
    heading3: { fontSize: 16, fontFamily: 'CormorantGaramond_600SemiBold', color: c.textPrimary, marginBottom: Spacing.xs, marginTop: Spacing.md },
    link: { color: c.cherry, fontFamily: 'CormorantGaramond_500Medium' },
    strong: { fontFamily: 'CormorantGaramond_600SemiBold' },
    paragraph: { fontFamily: 'CormorantGaramond_400Regular', lineHeight: 26, marginBottom: Spacing.sm },
    ...
    thead: {},
    tbody: {},
    code_inline: { backgroundColor: c.surfaceElevated, borderRadius: 4, paddingHorizontal: 4, fontFamily: 'CormorantGaramond_400Regular', fontSize: FontSize.sm },
    ...
    em: { fontFamily: 'CormorantGaramond_400Regular', fontStyle: 'italic' },
  };
}
