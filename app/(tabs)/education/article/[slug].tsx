...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    title: { fontSize: 26, fontFamily: 'Jost_600SemiBold', color: c.textPrimary, lineHeight: 32, marginBottom: Spacing.sm },
...
function createMarkdownStyles(c: AppColors) {
  return {
    ...
    heading1: { fontSize: 26, fontFamily: 'Jost_600SemiBold', color: c.textPrimary, marginBottom: Spacing.md, marginTop: Spacing.sm },
    heading2: { fontSize: 20, fontFamily: 'Jost_600SemiBold', color: c.textPrimary, marginBottom: Spacing.sm, marginTop: Spacing.lg },
