...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    notFoundText: { fontFamily: 'Jost_400Regular', color: c.textMuted },
    ...
    categoryText: { fontSize: 10, fontFamily: 'Jost_600SemiBold', color: c.cherry, letterSpacing: 1.2 },
    title: { fontSize: 26, fontFamily: 'CormorantGaramond_600SemiBold', color: c.textPrimary, lineHeight: 32, marginBottom: Spacing.sm },
    metaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: Spacing.md },
    metaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    metaText: { fontSize: FontSize.xs, fontFamily: 'Jost_400Regular', color: c.textMuted },
    metaDot: { color: c.textMuted, fontSize: FontSize.xs },
    divider: { height: 1, backgroundColor: 'rgba(180,150,140,0.2)', marginBottom: Spacing.lg },
    ...
    sourceLabel: { fontSize: FontSize.xs, fontFamily: 'Jost_400Regular', color: c.textMuted },
    sourceName: { fontSize: FontSize.sm, fontFamily: 'Jost_600SemiBold', color: c.textPrimary, marginTop: 1 },
  });
}

function createMarkdownStyles(c: AppColors) {
  return {
    body: { fontSize: FontSize.md, fontFamily: 'Jost_400Regular', color: c.textPrimary, lineHeight: 26 },
    heading1: { fontSize: 26, fontFamily: 'CormorantGaramond_600SemiBold', color: c.textPrimary, marginBottom: Spacing.md, marginTop: Spacing.sm },
    ...
    heading3: { fontSize: 16, fontFamily: 'Jost_600SemiBold', color: c.textPrimary, marginBottom: Spacing.xs, marginTop: Spacing.md },
    link: { color: c.cherry, fontFamily: 'Jost_500Medium' },
    ...
    thead: {},
    tbody: {},
    code_inline: { backgroundColor: c.surfaceElevated, borderRadius: 4, paddingHorizontal: 4, fontFamily: 'Jost_400Regular', fontSize: FontSize.sm },
