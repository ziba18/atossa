  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={styles.container}>
        <Icon name="shield" size={48} color={theme.textMuted} />
        <Text style={styles.title}>Coming soon</Text>
        <Text style={styles.body}>
          Emergency contacts will be available once the backend feature is ready. Your data stays safe and private in the meantime.
        </Text>
      </View>
    </SafeAreaView>
  );
