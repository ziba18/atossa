  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={styles.container}>
        <Icon name="link" size={48} color={theme.textMuted} />
        <Text style={styles.title}>Coming soon</Text>
        <Text style={styles.body}>
          Connected accounts — letting a partner or parent view your health data — will be available once the backend feature is ready.
        </Text>
      </View>
    </SafeAreaView>
  );
