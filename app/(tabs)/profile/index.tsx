...
function createStyles(c: AppColors) {
  ...
  return StyleSheet.create({
    ...
    avatarText: { fontSize: 36, fontFamily: 'CormorantGaramond_500Medium_Italic', color: '#FFFFFF' },
    name: { fontSize: FontSize.xl, fontFamily: 'CormorantGaramond_600SemiBold', color: '#FFFFFF', marginBottom: 4 },
    email: { fontSize: FontSize.sm, fontFamily: 'CormorantGaramond_400Regular', color: 'rgba(255,255,255,0.85)', marginBottom: 4 },
    memberSince: { fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_400Regular', color: 'rgba(255,255,255,0.7)' },
    ...
    statLabel: { fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_400Regular', color: Colors.textMuted, marginTop: 2, textAlign: 'center' },
    ...
    infoLabel: { fontSize: FontSize.sm, fontFamily: 'CormorantGaramond_400Regular', color: Colors.textSecondary, flex: 1 },
    infoValue: { fontSize: FontSize.sm, fontFamily: 'CormorantGaramond_500Medium', color: Colors.textPrimary },
    divider: { height: 1, backgroundColor: Colors.border },
    regularityBadge: { borderRadius: Radius.sm, paddingHorizontal: 8, paddingVertical: 3 },
    regularityText: { fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_600SemiBold', textTransform: 'capitalize' },
    editBtn: {
    ...
    editBtnText: { fontSize: FontSize.sm, fontFamily: 'CormorantGaramond_600SemiBold', color: Colors.cherry },
    ...
    menuLabel: { flex: 1, fontSize: FontSize.md, fontFamily: 'CormorantGaramond_500Medium', color: Colors.textPrimary },

    signOutBtn: { margin: Spacing.xl, padding: Spacing.md, alignItems: 'center' },
    signOutText: { fontSize: FontSize.md, fontFamily: 'CormorantGaramond_600SemiBold', color: Colors.cherry },
    footer: { textAlign: 'center', fontSize: FontSize.xs, fontFamily: 'CormorantGaramond_400Regular', color: Colors.textMuted },
  });
}
