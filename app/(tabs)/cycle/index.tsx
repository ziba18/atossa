...
function createStyles(c: AppColors) {
  ...
  return StyleSheet.create({
    ...
    sectionLabel:  { ...Type.cycle.sectionLabel, marginBottom: Spacing.sm },
    weekRow:       { flexDirection: 'row', justifyContent: 'space-between' },
    weekDay:       { alignItems: 'center', gap: 4 },
    weekDayName:   { ...Type.cycle.label, fontSize: 10 },
    weekDayBubble: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
    weekDayBubbleToday: { ...Shadow.sm },
    weekDayNum:    { ...Type.cycle.body, fontSize: 13 },
    weekPhase:     { ...Type.cycle.label, fontSize: 9 },
    ...
    eventLabel:    { flex: 1, ...Type.cycle.body, fontSize: 13.5 },
    eventDate:     { ...Type.cycle.cardTitle, fontSize: 13.5, fontFamily: 'Fraunces_400Regular_Italic' },
    ...
    aiText:        { flex: 1, ...Type.cycle.label, fontSize: 10.5, lineHeight: 15 },
    ...
    statValue:     { ...Type.cycle.statValue },
    statLabel:     { ...Type.cycle.statLabel, marginTop: 4 },
    ...
    emptyTitle:    { ...Type.cycle.section, textAlign: 'center' as const },
    emptySub:      { ...Type.cycle.body, textAlign: 'center' as const },
    ...
    emptyBtnText:  { fontSize: 15, fontFamily: 'Fraunces_500Medium', color: '#FFFFFF' },
  });
}
