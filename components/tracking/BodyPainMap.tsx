...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    toggleText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', color: c.textSecondary },
    toggleTextActive: { color: '#FFFFFF', fontFamily: 'Fraunces_600SemiBold' },
    instruction: { textAlign: 'center', fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.textMuted, marginBottom: Spacing.md },
    ...
    legendText: { fontSize: 10, fontFamily: 'Fraunces_400Regular', color: c.textMuted },
    loggedList: { backgroundColor: c.surface, borderRadius: Radius.lg, borderWidth: 1, borderColor: c.border, overflow: 'hidden' },
    loggedTitle: { fontSize: FontSize.xs, fontFamily: 'Fraunces_600SemiBold', color: c.textMuted, letterSpacing: 0.8, paddingHorizontal: Spacing.md, paddingTop: Spacing.md, paddingBottom: Spacing.xs },
    ...
    loggedDotText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_600SemiBold', color: '#FFFFFF' },
    loggedInfo: { flex: 1 },
    loggedRegion: { fontSize: FontSize.sm, fontFamily: 'Fraunces_600SemiBold', color: c.textPrimary },
    loggedMeta: { fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.textMuted, marginTop: 1 },
    editHint: { fontSize: FontSize.xs, fontFamily: 'Fraunces_500Medium', color: c.cherry },
    ...
    sheetRegion: { fontSize: FontSize.xl, fontFamily: 'Fraunces_600SemiBold', color: c.textPrimary },
    sheetSub: { fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.textMuted, marginTop: 2 },
    ...
    sectionLabel: { fontSize: 10, fontFamily: 'Fraunces_600SemiBold', color: c.textMuted, letterSpacing: 1.2, marginBottom: Spacing.sm, marginTop: Spacing.md },
    ...
    intensityNum: { fontSize: FontSize.sm, fontFamily: 'Fraunces_600SemiBold' },
    intensityDesc: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', marginTop: Spacing.sm },
    ...
    typeChipText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_400Regular', color: c.textSecondary },
    typeChipTextActive: { color: '#FFFFFF', fontFamily: 'Fraunces_600SemiBold' },
    notesInput: { backgroundColor: c.surfaceElevated, borderRadius: Radius.md, borderWidth: 1, borderColor: c.border, padding: Spacing.md, fontSize: FontSize.sm, fontFamily: 'Fraunces_400Regular', color: c.textPrimary, minHeight: 90, textAlignVertical: 'top' },
    actions: { gap: Spacing.sm, marginTop: Spacing.lg },
    saveBtn: { backgroundColor: c.cherry, borderRadius: Radius.full, paddingVertical: Spacing.md, alignItems: 'center' },
    saveBtnText: { fontSize: FontSize.md, fontFamily: 'Fraunces_600SemiBold', color: '#FFFFFF' },
    ...
    removeBtnText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', color: c.textMuted },
  });
}
