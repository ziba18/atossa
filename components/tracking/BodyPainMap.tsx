...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    toggleText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_400Regular', color: c.textSecondary },
    toggleTextActive: { color: '#FFFFFF', fontFamily: 'Fraunces_500Medium' },
    ...
    loggedTitle: { fontSize: FontSize.xs, fontFamily: 'Fraunces_500Medium', color: c.textMuted, letterSpacing: 0.8, paddingHorizontal: Spacing.md, paddingTop: Spacing.md, paddingBottom: Spacing.xs },
    ...
    loggedDotText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', color: '#FFFFFF' },
    loggedInfo: { flex: 1 },
    loggedRegion: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium', color: c.textPrimary },
    loggedMeta: { fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.textMuted, marginTop: 1 },
    editHint: { fontSize: FontSize.xs, fontFamily: 'Fraunces_400Regular', color: c.cherry },
    ...
    sheetRegion: { fontSize: FontSize.xl, fontFamily: 'Fraunces_500Medium', color: c.textPrimary },
    ...
    sectionLabel: { fontSize: 10, fontFamily: 'Fraunces_300Light', color: c.textMuted, letterSpacing: 1.2, marginBottom: Spacing.sm, marginTop: Spacing.md },
    ...
    intensityNum: { fontSize: FontSize.sm, fontFamily: 'Fraunces_500Medium' },
    intensityDesc: { fontSize: FontSize.sm, fontFamily: 'Fraunces_400Regular', marginTop: Spacing.sm },
    ...
    typeChipTextActive: { color: '#FFFFFF', fontFamily: 'Fraunces_500Medium' },
    ...
    saveBtnText: { fontSize: FontSize.md, fontFamily: 'Fraunces_500Medium', color: '#FFFFFF' },
    ...
    removeBtnText: { fontSize: FontSize.sm, fontFamily: 'Fraunces_400Regular', color: c.textMuted },
  });
}
