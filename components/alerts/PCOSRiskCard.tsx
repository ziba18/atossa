...
const styles = StyleSheet.create({
  ...
  title: { fontSize: FontSize.md, fontFamily: 'Jost_600SemiBold', color: Colors.textPrimary },
  barBg: { height: 8, backgroundColor: Colors.border, borderRadius: Radius.full },
  barFill: { height: 8, borderRadius: Radius.full },
  score: { fontSize: FontSize.sm, fontFamily: 'Jost_600SemiBold', alignSelf: 'flex-end' },
  factors: { marginTop: Spacing.xs },
  factorsTitle: { fontSize: FontSize.sm, fontFamily: 'Jost_600SemiBold', color: Colors.textSecondary },
  factor: { fontSize: FontSize.sm, fontFamily: 'Jost_400Regular', color: Colors.textSecondary, marginTop: 2 },
  recommendation: {
