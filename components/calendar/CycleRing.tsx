...
function useStyles() {
  ...
  return StyleSheet.create({
    ...
    topLabel: { fontSize: 9, fontFamily: 'Fraunces_300Light', color: theme.textMuted, letterSpacing: 2.5, marginBottom: 2 },
    dayNum: { fontSize: 64, fontFamily: 'Fraunces_400Regular_Italic', lineHeight: 66, letterSpacing: -2 },
    ...
    phaseName: { fontSize: 11, fontFamily: 'Fraunces_500Medium', letterSpacing: 0.5 },
    ...
    statValue: { fontSize: 28, fontFamily: 'Fraunces_400Regular_Italic', color: theme.textPrimary, lineHeight: 30 },
    statLabel: { fontSize: 8.5, fontFamily: 'Fraunces_300Light', color: theme.textMuted, letterSpacing: 1.2 },
